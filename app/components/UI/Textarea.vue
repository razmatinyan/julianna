...
<template>
	<div class="relative w-full pb-6 group">
		<textarea
			...
			class="peer w-full bg-white/5 border border-white/10 rounded-sm px-4 py-4 text-neutral-200 focus:outline-none focus:border-white/40 focus:bg-white/10 transition-all duration-500 placeholder-transparent resize-none"
